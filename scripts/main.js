...
//////////////////////////////////////////////////////////////////////////////////         OPDRACHT 1 ////////////////
const numberOfEmployeesSales = departments.sales.numberOfEmployees;
console.log(
  "De afdeling Sales heeft " + numberOfEmployeesSales + " medewerkers"
);

const descriptionMarketing = departments.marketing.description;
console.log(
  "Marketing is een leuke afdeling om te werken. " + descriptionMarketing
);

const numberOfEmployeesCustomerService =
  departments["customer-service"].numberOfEmployees;
console.log(
  "De afdeling Customer Service heeft " +
    numberOfEmployeesCustomerService +
    " medewerkers"
);
...
console.log(
  "Sales is een uitdagende afdeling om te werken als Verkoopmanager. " +
    descriptionSales
); // je kan ook gewoon de 1e string eindigen met een spatie in plaats van een nieuwe " " er tussen te doen.

////////////// Feedback bij deze opdracht
// Je hebt de opdracht goed uitgevoerd. Je hebt de juiste properties en values opgehaald en in de console gelgd. TIP: gebruik altijd const als je geen let hoeft te gebruiker, data wordt 1x opgehaald en toegewezen aan een variabele en wordt niet opnieuw toegekend in je programma dus const is hier beter.
...
if (userInput.toLowerCase() === "sales") {
  // toLowerCase() zorgt ervoor dat het altijd in kleine letters wordt ingevoerd. Als iemand dus SALES invoerd, wordt het alsnog herkend.
  console.log("Je koos" + " " + userInput + ". " + descriptionSales);
} else if (userInput === "marketing") {
  console.log("Je koos" + " " + userInput + ". " + descriptionMarketing);
} else if (userInput === "customer-service") {
  console.log("Je koos" + " " + userInput + ". " + descriptionCustomerService);
} else {
  console.error(
    "Ongeldige keuze. Probeer opnieuw door de pagina te verversen."
  );
}

//////////////////////////////////////////////////////////////////////////////////         OPDRACHT 3 ////////////////

// const inputDepartment = prompt("Je koos marketing. Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in. " +
//     "0 = Marketingmanager " +
//     "1 = Digital Marketing Specialist " +
//     "2 = Contentmarketeer " +
//     "3 = Branding Agent ");
//
// const department = inputDepartment
//
// switch (department) {
//     case "0":
...
console.log(
  userInput +
    " is een leuke afdeling om op te werken. Er werken op dit moment " +
    departments[userInput].numberOfEmployees +
    " medewerkers"
);

const inputJobs = prompt(
  "Je koos" +
    userInput +
...
const department = inputJobs; // deze variabele is onnodig je kan de switch gewoon beginnen met inputJobs

switch (
  inputJobs // ipv department
) {
  case "0":
    console.log(
      "Je koos" +
